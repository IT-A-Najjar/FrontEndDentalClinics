...
import { faTwitter, faFacebook, faInstagram, faGooglePlus } from '@fortawesome/free-solid-svg-icons';
...
import Loding from "../../Dashboard/Managment/Loding";
    ...
    <div>
      <section className="ftco-section">
        <div className="container_1">
          ...
          <div className="row">
            <div className="col-lg-3 col-md-5 d-flex mb-sm-4 ftco-animate fadeInUp ftco-animated card__patient">
                <div className="staff ">
                  ...
                  <div className="info text-center">
                    ...
                    <p className="doc">bkj,ghk</p>
                      <p  className="doc">ماجستير في امراض اللثة وجراحتها</p>
                    <div className="text-card-doctor">
